...
import tests.methods.MethodsNur;
...
public class US018_all extends TestBaseRapor {
    ...
    public void requestID() {
        MethodsNur.isInTable("Request ID");
    ...
    public void typeAndReasonValues() {
        MethodsNur.isInTable("Type");
        MethodsNur.isInTable("Reason");
